                ...
                <div class="card-body">
                  <div class="form-group">
                   {{--  <label for="exampleInputEmail1">Product name</label>
                    ...
                    {{ Form::label('', 'Nom du Produit', ['for' => 'exampleInputEmail']) }}
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::text('product_price', $product->product_price, ['class' => 'form-control' , 'id' => 'exampleInputEmail', 'placeholder' => 'Enter product price']) !!}
                  </div>
                  <div class="form-group">
